...
void main() {
  test(
    ...
    () {
      ...
      expect(match!.group(1), '1.0.19-hermesapk.19');
  ...
  test('Gradle and CI enforce the accepted APK upgrade floor', () {
    ...
    expect(gradle, contains('minimumInstalledVersionCode = 2130'));
    expect(
      gradle,
      contains('check(flutter.versionCode > minimumInstalledVersionCode)'),
    );
    expect(buildWorkflow, contains("MINIMUM_INSTALLED_VERSION_CODE: '2130'"));
    expect(buildWorkflow, contains("REQUIRED_BASE_VERSION_CODE: '2131'"));
    ...
    expect(qualityWorkflow, contains("MINIMUM_INSTALLED_VERSION_CODE: '2130'"));
